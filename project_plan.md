...
|---|---|---|---|
| Recept generálás (AI modellekből) | Érték | L | Duál modell ensemble (finomhangolt T5 + custom TransformerV4), fallback kezelés, timeout kezelés |
...
Az ML modellek betöltése és memória-hatékony futtatása GPU/CPU eszközön. A finetuned T5 és custom TransformerV4 modellek nagy memóriaigényűek, ezért hardverkorlátok, timeout-ok és fallback stratégiák kezelése kritikus.
...
| ML / AI | PyTorch + Hugging Face Transformers (finomhangolt T5 + custom TransformerV4) | Ipari szabvány, előtanított súlyok, egyszerű integráció, eszközdetektálás (CUDA/CPU) |
...
- ML modellek: benne maradjon mindkettő (finetuned T5 + custom TransformerV4) vagy csak a finomhangolt?
